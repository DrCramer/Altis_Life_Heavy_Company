...
_role1 = "Добро пожаловать на Heavy Company Altis Life RPG"; //In red
...
_role7names = ["Windows Key - Действие/Собирать<br/>Y Key - Меню игрока <br/> SHIFT+H - Спрятать оружие <br/> CTRL+H - Достать оружие <br/> SHIFT+V -  Surrender <br/> SHIFT+T -  Использовать кирку <br/> SHIFT+SPACE - Прижок"];
