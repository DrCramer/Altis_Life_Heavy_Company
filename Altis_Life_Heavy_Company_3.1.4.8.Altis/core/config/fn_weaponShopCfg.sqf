			...
			default
			{
				["Weapon shop",
					[
						...
						["RPG7V",nil,500],
						["PG7V","Снаряд",110],
						["PG7VL","Бронебойный снаряд",110],
						["PG7VR","Снаряд Аллаха",110],
						["OG7","ОФ Снаряд",110],
						...
						["RH_sw659","SMITH&WESSON 645",500],
						["RH_14Rnd_9x19_sw",nil,250],
						["RH_usp","Heckler&Koch USP",500],
						["RH_uspm","Heckler&Koch USP Match",500],
						["RH_12Rnd_45cal_usp",nil,250],
						["RH_mak","Пистолет Макарова",500],
						["RH_8Rnd_9x18_Mak",nil,250],
						["RH_m1911",nil,100],
						["RH_kimber",nil,500],
						["RH_kimber_nw",nil,500],
						["RH_7Rnd_45cal_m1911",nil,100],
						["RH_m9","Беретта 92FS (M9)",500],
						["RH_m9c","Беретта 92FS (M9) Camo",500],
						...
						["RH_p226","SIG-Sauer P226",500],
						["RH_p226s","SIG-Sauer P226 Silver",500],
						["RH_15Rnd_9x19_SIG",nil,250],
						["RH_mk2","Ruger Mk.II Amphibian",500],
						...
						["Trixie_LSMARK4",nil,1000],
						["Trixie_LSMARK4_Delta",nil,1000],
						["Trixie_SB31250",nil,1000],
						["Trixie_SB31250_Net",nil,1000],
						["Trixie_M68CCO",nil,1000],
						["Trixie_M68CCO_Net",nil,1000],
						["Trixie_Cyclone",nil,1000],
						["Trixie_Cyclone_Camo",nil,1000],
						["Trixie_Cyclone_Net",nil,1000],
						["Trixie_Ranger3",nil,1000],
						["Trixie_Ranger3_Camo",nil,1000],
						["Trixie_Ranger3_Net",nil,1000],
						["Trixie_20x762_Mag",nil,500],
						["Trixie_10x762_Mag",nil,500],
						["Trixie_5x762_Mag",nil,5000],
						["Trixie_5x338_Mag",nil,500],
						["Trixie_10x127_Mag",nil,500],
						["Trixie_30x556_Mk262_Mag",nil,100],
			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						...
						["RPG7V",nil,70000],
						["PG7V","Бронебойный Снаряд",5000],	
						["PG7VL","Снаряд Аллаха",20000],
						["OG7","ОФ Снаряд",10000],	
						...
						["Trixie_LSMARK4",nil,5000],
						["Trixie_LSMARK4_Delta",nil,5000],
						["Trixie_SB31250",nil,5000],
						["Trixie_SB31250_Net",nil,5000],
						["Trixie_M68CCO",nil,5000],
						["Trixie_M68CCO_Net",nil,5000],
						["Trixie_Cyclone",nil,5000],
						["Trixie_Cyclone_Camo",nil,5000],
						["Trixie_Cyclone_Net",nil,5000],
