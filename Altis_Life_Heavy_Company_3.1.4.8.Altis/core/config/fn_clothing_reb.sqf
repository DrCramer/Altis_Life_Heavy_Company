...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_PMC_CombatUniformLS_BSGPBB",nil,0],
			["U_PMC_CombatUniformLS_BSGPSB",nil,0],
			["U_PMC_CombatUniformLS_BSSPBB",nil,0],
			["U_PMC_CombatUniformLS_BSSPSB",nil,0],
			["U_PMC_CombatUniformLS_GSBPBB",nil,0],
			["U_PMC_CombatUniformLS_GSSPBB",nil,0],
			["U_PMC_CombatUniformLS_IndPBSBB",nil,0],
			["U_PMC_CombatUniformLS_SSBPBB",nil,0],
			["U_PMC_CombatUniformLS_SSGPBB",nil,0],
			["U_PMC_CombatUniformLS_SSGPSB",nil,0],
			["U_PMC_CombatUniformLS_ChckDBS_GPSB",nil,0],
			["U_PMC_CombatUniformLS_ChckLB_GPBB",nil,0],
			["U_PMC_CombatUniformLS_ChckLR_SPBB",nil,0],
			["U_PMC_CombatUniformLS_ChckP_BPBB",nil,0],
			["U_PMC_CombatUniformRS_BSGPBB",nil,0],
			["U_PMC_CombatUniformRS_BSGPSB",nil,0],
			["U_PMC_CombatUniformRS_BSSPBB",nil,0],
			["U_PMC_CombatUniformRS_BSSPSB",nil,0],
			["U_PMC_CombatUniformRS_GSBPBB",nil,0],
			["U_PMC_CombatUniformRS_GSSPBB",nil,0],
			["U_PMC_CombatUniformRS_IndPBSBB",nil,0],
			["U_PMC_CombatUniformRS_SSBPBB",nil,0],
			["U_PMC_CombatUniformRS_SSGPBB",nil,0],
			["U_PMC_CombatUniformRS_SSGPSB",nil,0],
			["U_PMC_CombatUniformRS_ChckDBS_GPSB",nil,0],
			["U_PMC_CombatUniformRS_ChckLB_GPBB",nil,0],
			["U_PMC_CombatUniformRS_ChckLR_SPBB",nil,0],
			["U_PMC_CombatUniformRS_ChckP_BPBB",nil,0],
