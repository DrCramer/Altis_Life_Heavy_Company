		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN <= 0) then
					{
						D41_Nebel = [0,0,0]; D41_Wellen = 0; D41_Vorschau = 0.2; D41_Regen = 0; D41_RegenCounter = 0;
				...
				if(D41_ChanceN >=11 && D41_ChanceN <= 30 && D41_RegenCounter == 0) then
					{
						...
						D41_WMod = round(random 9);
						if(D41_WMod == 0)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 1;	D41_Regen = 0.6;};
						if(D41_WMod == 1)	then {D41_Nebel = 0.3;	D41_Wellen = 1;		D41_Vorschau = 1;	D41_Regen = 0.6;};
						if(D41_WMod == 2)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.9;	D41_Regen = 0.5;};
						if(D41_WMod == 3)	then {D41_Nebel = 0.2;	D41_Wellen = 0.8;	D41_Vorschau = 0.8;	D41_Regen = 0.5;};
						if(D41_WMod == 4)	then {D41_Nebel = 0.1;	D41_Wellen = 0.8;	D41_Vorschau = 0.7;	D41_Regen = 0.3;};
						if(D41_WMod == 5)	then {D41_Nebel = 0.1;	D41_Wellen = 0.6;	D41_Vorschau = 0.7;	D41_Regen = 0.3;};
						if(D41_WMod == 6)	then {D41_Nebel = 0.1;	D41_Wellen = 0.4;	D41_Vorschau = 0.6;	D41_Regen = 0.2;};
						if(D41_WMod == 7)	then {D41_Nebel = 0.1;	D41_Wellen = 0.2;	D41_Vorschau = 0.5;	D41_Regen = 0.2;};
						if(D41_WMod == 8)	then {D41_Nebel = 0.1;	D41_Wellen = 0.1;	D41_Vorschau = 0.4;	D41_Regen = 0.2;};
						if(D41_WMod == 9)	then {D41_Nebel = 0.1;	D41_Wellen = 0;		D41_Vorschau = 0.4;	D41_Regen = 0.1;};
					};
				...
				if(D41_ChanceN >=31 && D41_ChanceN <= 90) then
				{
					D41_Nebel = [0,0,0]; D41_Wellen = 0; D41_Vorschau = 0.2; D41_Regen = 0; D41_RegenCounter = 0;
					D41_WMod = round(random 9);
					if(D41_WMod == 0)	then {D41_Vorschau = 0.9;};
					if(D41_WMod == 1)	then {D41_Vorschau = 0.9;};
					if(D41_WMod == 2)	then {D41_Vorschau = 0.7;};
					if(D41_WMod == 3)	then {D41_Vorschau = 0.7;};
					if(D41_WMod == 4)	then {D41_Vorschau = 0.6;};
					if(D41_WMod == 5)	then {D41_Vorschau = 0.6;};
					if(D41_WMod == 6)	then {D41_Vorschau = 0.5;};
					if(D41_WMod == 7)	then {D41_Vorschau = 0.5;};
					if(D41_WMod == 8)	then {D41_Vorschau = 0.4;};
					if(D41_WMod == 9)	then {D41_Vorschau = 0.4;};
					
				};

				if(D41_ChanceN >=91 && D41_ChanceN <= 100) then
				{
					D41_Nebel = [0,0,0]; D41_Wellen = 0; D41_Vorschau = 0.2; D41_Regen = 0; D41_RegenCounter = 1;
					D41_WMod = round(random 2);
					if(D41_WMod == 0)	then {D41_Vorschau = 0.2;};
					if(D41_WMod == 1)	then {D41_Vorschau = 0.2;};
					if(D41_WMod == 2)	then {D41_Vorschau = 0.1;};				
				};
